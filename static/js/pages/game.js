  ...
  onMount() {
    ...
    class Game {
      ...
      endgame() {
        ...
        // Message du gagnant
        const winner =
          player_left.getScore() > player_right.getScore() ? 'Left Player' : 'Right Player';
    ...
    startGame.addEventListener('click', async () => {
      try {
        ...
        document.addEventListener('game-update', this.handleGameUpdate.bind(this));

        // Send game settings to server
        this.gameManager.sendGameEvent('game_settings', gameSettings);
      } catch (error) {
